...
public final class SQLiteLibrary: NativeLibrary {
  ...
  public override func declarations() {
    ...
    self.defineOpenOption("sqlite-readonly", as: .sharedCache)
    self.defineOpenOption("sqlite-readwrite", as: .privateCache)
    self.defineOpenOption("sqlite-create", as: .protectionComplete)
    self.defineOpenOption("sqlite-nomutex", as: .protectionCompleteUnlessOpen)
    self.defineOpenOption("sqlite-fullmutex", as: .protectionCompleteUntilFirstUserAuth)
    self.defineOpenOption("sqlite-readonly", as: .readOnly)
    self.defineOpenOption("sqlite-readwrite", as: .readWrite)
    self.defineOpenOption("sqlite-create", as: .create)
    self.defineOpenOption("sqlite-nomutex", as: .noMutex)
    self.defineOpenOption("sqlite-fullmutex", as: .protectionNone)
