...
public final class SystemLibrary: NativeLibrary {
  ...
  private func environmentInfo() -> Expr {
    ...
    console.print("ALLOCATED OBJECTS\n")
    console.print("  Boxes              : \(Cell.allocated)\n")
    console.print("  Mutable pairs      : \(Tuple.allocated)\n")
    console.print("  Collection objects : \(Collection.allocated)\n")
    console.print("  Hashtables         : \(HashTable.allocated)\n")
    console.print("  Promises           : \(Promise.allocated)\n")
    console.print("  Procedures         : \(Procedure.allocated)\n")
