...
;;;
;;; Even though the specification also applies to Unicode character sets, this implementation
;;; corresponds to the reference implementation and only deals with ASCII and Latin-1.
;;; The data structures and algorithms would have to be altered for larger 16 or 32-bit
;;; character types such as Unicode.
;;;
...
;;;
;;; Copyright © 1988-1995 Massachusetts Institute of Technology
;;; The MIT Scheme license is a "free software" license. See the end of this file for the
;;; tedious details.
;;;
;;; Adaptation to LispKit
;;;   Copyright © 2018 Matthias Zenger. All rights reserved.

(define-library (srfi 14 ascii)
  ...
  (begin
    ...
    (define (char-set-hash cs . maybe-bound)
      (let* ((bound (if (null? maybe-bound) 4194304 (car maybe-bound)))  ; 0 means default.
    ...
    (define char-set:upper-case
      (let ((A-Z (ucs-range->char-set #x41 #x5B)))
        (ucs-range->char-set! #xd8 #xdf #t (ucs-range->char-set! #xc0 #xd7 #t A-Z))))
