;;; SCHEME RED
;;;
;;; Library exporting all definitions of the R7RS "Red" large standard that are currently
;;; supported by LispKit.
;;;
...
(define-library (scheme red)
  ...
  (import (scheme base)
          ...
          (scheme file)
          (scheme generator)
          (except (scheme hash-table) string-ci-hash string-hash)
          (scheme ideque)
          ; (scheme ilist)
          (scheme inexact)
          (scheme lazy)
